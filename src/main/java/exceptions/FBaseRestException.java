...
public class FBaseRestException extends FBaseException {
	...
	public static final String DATAIDENTIFIER_MISSING = "The mandatory query parameter "
			+ "dataIdentifier is missing or not parseable";
	public static final String KEYGROUP_MISSING = "The mandatory query parameter "
			+ "keygroupID is missing or not parseable";
